...
def read_data():
    ...
    # 返回的是28*28的shape，不要被这里的1给迷惑了，这里要注意60000，有60000个大的list，里面每一个list代表一张图片,这里的1表示维度，1表示黑白，3表示彩色
    ...
    for i, label in enumerate(Y):
        y_vec[i, int(Y[i])] = 1.0 # Y[i]是基于0-9之间的，将相当于随机在[70000,10]这个tensor中随机置1，这就是独热编码
